export const firebaseService = {
  ...
  client_email: process.env.FIREBASE_CLIENT_EMAIL || 'firebase-adminsdk-1gysd@sns-chat-dev.iam.gserviceaccount.com',
  client_id: process.env.FIREBASE_CLIENT_ID || '118444229404027110527',
